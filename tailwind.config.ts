  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        runway: {
          green: "hsl(var(--runway-green))",
          yellow: "hsl(var(--runway-yellow))",
          red: "hsl(var(--runway-red))",
        },
        status: {
      ...
      keyframes: {
        ...
        "cascade-in": { from: { opacity: "0", transform: "translateY(-8px)" }, to: { opacity: "1", transform: "translateY(0)" } },
