                  ...
                  {isCarousel && carouselSlides.length > 0 ? (
                    ...
                    <>
                      <div className="p-2 sm:p-3">
                        <div className="mx-auto relative aspect-[9/16] max-h-[75vh] sm:max-h-[70vh] w-auto bg-black rounded-[20px] sm:rounded-[24px] ring-1 ring-white/10 overflow-hidden" style={{ width: "min(100%, calc(75vh * 9 / 16))" }}>
                          <PreviewVideoPlayer
