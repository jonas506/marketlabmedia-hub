...
interface PieceEditingControlsProps {
  piece: ContentPiece;
  canEdit: boolean;
...
const PieceEditingControls: React.FC<PieceEditingControlsProps> = React.memo(({
  piece,
  canEdit,
  onOpenScript,
  onUpdatePiece,
...
PieceEditingControls.displayName = "PieceEditingControls";

export default PieceEditingControls;
